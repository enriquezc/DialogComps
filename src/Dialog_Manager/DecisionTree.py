...
class DecisionTree:
    ...
    def build_Tree(self):
        ...
        self.mapOfNodes[User_Query.QueryType.student_info_major_requirements].required_questions.extend([self.mapOfNodes[User_Query.QueryType.new_class_name]])  # Ask if they want to take a course that fills these reqs
