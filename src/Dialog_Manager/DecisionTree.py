...
class DecisionTree:
    ...
    def build_Tree(self):
        ...
        self.mapOfNodes[User_Query.QueryType.new_class_name].potential_next_questions.extend([self.mapOfNodes[User_Query.QueryType.schedule_class_res], self.mapOfNodes[User_Query.QueryType.student_info_interests], self.mapOfNodes[User_Query.QueryType.student_info_requirements]])  # prof, recommend
